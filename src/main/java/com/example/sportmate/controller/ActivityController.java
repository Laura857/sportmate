...
public class ActivityController {
    ...
    public ActivityResponseDto createActivity(@RequestBody final ActivityRequestDto activityRequestDto,
    ...
    public ActivityResponseDto updateActivity(@RequestBody final ActivityRequestDto activityRequestDto,
